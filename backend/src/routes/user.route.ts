 ...
 *         schema:
 *           type: string
 *         description: User's invitation code
 *       - in: query
 *         name: sortBy
 *         schema:
 *           type: string
 ...
 * /users/invite:
 *   get:
 *     summary: Get user invite details by invite code or email
 *     description: This API is used to get user invite details by invite code.
 *     tags: [Users]
 *     parameters:
 *       - in: query
 *         name: code
 ...
 *         schema:
 *           type: string
 *         description: invite code (optional xor email)
 *       - in: query
 *         name: email
 *         required: false
 *         schema:
 *           type: string
 *         description: invite email (optional xor code)
 *     responses:
 *       "200":
 *         description: OK
 *         content:
